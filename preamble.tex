...
%    \section*{\centering\uline{\hfill #1 \hfill }} % Center the headings
    \section*{\normalsize \uline{#1 \hfill}} % Right-align the headings
}
\newcommand{\squish}{
...
\newcommand{\experience}[4]{ % place, optional title, date
\item[]
	{\bf#1,}{ \emph{ #2} }\hfill #4
...
\newcommand{\contact}[4]{
	\centerline{ \large \texttt{ #1 $\hfill$ #2}}
	\centerline{ \large \texttt{ #3 $\hfill$ #4}}
